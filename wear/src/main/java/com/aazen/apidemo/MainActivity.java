...
import com.aazen.android.wearable.DataMapItem;
...
public class MainActivity extends Activity implements ConnectionCallbacks,
        ...
        for (DataEvent event : events) {
            if (event.getType() == DataEvent.TYPE_CHANGED) {
                ...
                if (DataLayerListenerService.IMAGE_PATH.equals(path)) {
                    ...
                    final Bitmap bitmap = loadBitmapFromAsset(mAazenApiClient, photo);
     ...
     * {@link com.aazen.android.wearable.Asset}
     */
    private Bitmap loadBitmapFromAsset(AazenApiClient apiClient, Asset asset) {
        if (asset == null) {
