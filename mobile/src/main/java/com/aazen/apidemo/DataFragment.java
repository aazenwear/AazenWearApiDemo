...
import com.aazen.android.common.data.FreezableUtils;
import com.aazen.android.wearable.Asset;
import com.aazen.android.wearable.DataApi;
import com.aazen.android.wearable.DataEvent;
...
import com.aazen.android.wearable.PutDataMapRequest;
import com.aazen.android.wearable.PutDataRequest;
...
public class DataFragment extends Fragment implements View.OnClickListener,
    ...
    /**
     * Builds an {@link com.aazen.android.wearable.Asset} from a bitmap. The image that we get
    ...
    public void onStop() {
        if (!mResolvingError) {
            Wearable.DataApi.removeListener(mAazenApiClient, mDataListener);
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        Wearable.DataApi.addListener(mAazenApiClient, mDataListener);
    ...
    private void sendPhoto(Asset asset) {
        ...
        Wearable.DataApi.putDataItem(mAazenApiClient, request)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.sendPhoto: {
                if (null != mImageBitmap && mAazenApiClient.isConnected()) {
    ...
    private class DataItemGenerator implements Runnable {
        ...
        public void run() {
            ...
            if (!mAazenApiClient.isConnected()) {
                return;
            }
            Wearable.DataApi.putDataItem(mAazenApiClient, request)
                    .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
